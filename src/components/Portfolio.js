            ...
            <ul className="gallery_zoom grid">
              ...
              <li className="template grid-item">
                <div className="inner">
                  ...
                  >
                    <a className="zoom" href="https://hars123h.github.io/sliet-coe/index.html" target="blank">
                      <img src="img/thumbs/42-56.jpg" alt="image" height={480} />
                      <div
                        className="main"
              ...
              <li className="frontend grid-item">
                <div className="inner">
                  <div
                    ...
                    data-category="frontend"
                  >
                    <a className="zoom" href="https://eposture-hazel.vercel.app/" target="blank" >
                      <img src="img/thumbs/42-34.jpg" alt="image" height={270} />
                      <div
                        className="main"
              ...
              <li className="template grid-item">
                <div className="inner">
                  <div
                    ...
                    data-category="template"
                  >
                    <a className="portfolio_popup" href="https://hars123h.github.io/Blog-template.github.io/" target="blank" >
                      <img src="img/thumbs/42-34.jpg" alt="image" height={270} />
                      <div
                        className="main"
               ...
               <li className="template grid-item">
                <div className="inner">
                  ...
                  > 
                    <a
                      className="popup-youtube"
                      href="https://hars123h.github.io/beauty-parlour.github.io/" target="blank"
                    >
                      <img src="img/thumbs/42-56.jpg" alt="image" height={480} />
                      <div
                        className="main"
              ...
              <li className="frontend grid-item">
                <div className="inner">
                  <div
                    ...
                    data-category="frontend"
                  >
                    <a className="zoom" href="https://hars123h.github.io/tripathi-harsh.github.io/"  target="blank">
                      <img src="img/thumbs/42-56.jpg" alt="image" height={480} />
                      <div
                        className="main"
                        data-img-url="img/portfolio/blog.jpg"
              ...
              <li className="template grid-item">
                <div className="inner">
                  <div
                    ...
                    data-category="template"
                  >
                    <a className="zoom" href="https://hars123h.github.io/restraunt.github.io/" target="blank" >
                      <img src="img/thumbs/42-34.jpg" alt="image" height={270} />
                      <div
                        className="main"
